...
urlpatterns = [
    ...
    path('inbox_status/', views.inbox_status, name='inbox_status'),
    ...
    path('email/<int:id>/export-pdf/', views.export_pdf, name='export_pdf'),
    ...
    path('attachment/<int:id>/download/', views.download_attachment, name='download_attachment'),
    path('attachment/<int:id>/preview/', views.preview_attachment, name='preview_attachment'),
